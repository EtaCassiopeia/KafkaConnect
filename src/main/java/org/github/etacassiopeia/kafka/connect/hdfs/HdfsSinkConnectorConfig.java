...
public class HdfsSinkConnectorConfig extends AbstractConfig {
    ...
    public static final String FORMAT_CLASS_DEFAULT = "org.github.etacassiopeia.kafka.connect.hdfs.parquet.ParquetFormat";
    ...
    public static final String PARTITIONER_CLASS_DEFAULT =
            "org.github.etacassiopeia.kafka.connect.hdfs.partitioner.DefaultPartitioner";
    ...
    public static final String STORAGE_CLASS_DEFAULT = "org.github.etacassiopeia.kafka.connect.hdfs.storage.HdfsStorage";
